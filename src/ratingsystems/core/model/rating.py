...
class Rating():
    ...
    Parameters:
        ...
        **auxillary_data: additional fields to be stored on the #Rating; this can be sub rating, additional data needed for a predictor, or anything else useful to a consumer of the rating<br>
